...
async def commands_cmd(update: Update, context: CallbackContext):
    ...
    msg = (
        ...
        "• `/ask <question>` — Ask the AI assistant a question about the game.\n"
        "• `/time <location | @username>` — Get the current exact time for a user or location.\n"
        "• `/settime <location>` — Set your own local time zone/location.\n\n"
